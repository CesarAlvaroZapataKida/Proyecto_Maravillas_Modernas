...
public class web extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rediriguir = view.findViewById(R.id.Rediriguir);

        rediriguir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {



                Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("https://academiaandroid.com/activity-y-fragments/"));
                startActivity(i);
